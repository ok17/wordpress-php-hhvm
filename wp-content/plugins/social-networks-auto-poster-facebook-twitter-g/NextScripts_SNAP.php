...
*/
define( 'NextScripts_SNAP_Version' , '3.5.1' );
...
require_once "nxs_functions.php"; require_once "inc/nxs_functions_adv.php"; require_once "inc/nxs_snap_class.php";  require_once "inc/nxs_ntlist_class.php"; require_once "inc/nxs_oauth_class.php";
...
if (!function_exists("nxs_snapAjax")) { function nxs_snapAjax() { check_ajax_referer('nxsSsPageWPN'); $arg = '';
  ...
  if ($_POST['nxsact']=='setNTset') { global $nxs_snapAvNts; unset($_POST['action']); unset($_POST['nxsact']); unset($_POST['_wp_http_referer']); unset($_POST['_wpnonce']); //unset($_POST['apDoSFB0']); // Do something
    ...
    }  nxs_settings_save($networks); $plgn_NS_SNAutoPoster->nxs_options = $networks; //prr($_POST['xi']);  prr($networks['xi']); // die('OK');
