...
<?php // 3PR area 1 =========================================================== ?>
		<?php // 3PR area 1 タイトル ?>
		<h5><?php _e( '3PR title', 'vkExUnit' ); ?></h5>
		<?php // カスタマイズ ?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' );  ?>"><?php _e( 'エリアタイトル:', 'vkExUnit' ); ?></label><br/>
			<input type="text" id="<?php echo $this->get_field_id( 'title' ); ?>-title" class="pr-input" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
		</p>
...
<hr /><?php // 3PR area 3  =================================================?>
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['title'] = $new_instance['title']; // カスタマイズ
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty($instance['title'])) {
			echo '<h1 class="mainSection-title">';
			echo $instance['title'];
			echo '</h1>';
		}
